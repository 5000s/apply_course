...
class DashboardController extends Controller
{
    ...
    private function normalizeNationalityCountry(?string $raw): ?string
    {
        ...
        $map = [
            ...
            'Myanmar'         => ['myanmar', 'burma', 'พม่า', 'brumar'],
            ...
            'Australia'       => ['australia', 'australian', 'ออสเตร', 'aussie'],
            'New Zealand'     => ['new zealand', 'new zealander', 'kiwi'],
            'Austria'         => ['austria', 'austrian'],
            'France'          => ['france', 'french', 'ฝรั่งเศส', 'français'],
            ...
            'Switzerland'     => ['switzerland', 'สวิส', 'swiss'],
            ...
            'Netherlands'     => ['netherlands', 'nederland', 'dutch', 'duch', 'ดัช', 'natherland'],
            'Spain'           => ['spain', 'spanish'],

    ...
    @php
        ...
        $t = [
            'th' => [
                ...
                'warning_msg' => '**** ทีมงาน เพียงแค่รับใบสมัคร และบันทึกคำขอยื่นใบสมัครของท่านไว้เท่านั้น **** <br>
            ...
            'en' => [
                ...
                'warning_msg' => '**** The team has only received your application request **** <br>
                                This application is <strong>* NOT *</strong> a confirmation of acceptance.
                                You must receive interview call and confirmation from foundation staff via number
                                <strong>02-117-4063 to 64</strong>
                                about 1-3 weeks before the course starts <strong>*ONLY*</strong> to be eligible.
                                Please save the foundation number for contact.',
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h2 class="fw-bold text-primary">{{ $txt['header_success'] }}</h2>
                        </div>

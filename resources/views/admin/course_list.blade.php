...
@section('content')
    ...
    <style>
        ...
        .table th {
            ...
            /* Aligns text vertically in table cells */
        }
    ...
    <div class="container" id='hidden'>
        ...
        <form action="{{ route('admin.courses') }}" method="get">
            <div class="top-layer">
                <div
                    class="headerBar py-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                    ...
                    <div class="d-flex flex-wrap gap-3 w-100">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <select class="form-select" name="location" id="location">
                                ...
                                <option @if ($location == 1) selected @endif value="1">
                                    สระบุรี-โพธิธรรมญาณสถานเตชะชัยสิทธิ </option>
                                <option @if ($location == 2) selected @endif value="2">
                                    สุรินทร์-ลานหินป่าโมกข์ </option>
                                <option @if ($location == 3) selected @endif value="3">
                                    หาดใหญ่-แสงธรรมโพธิญาณ </option>
                                <option @if ($location == 4) selected @endif value="4">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <select class="form-select" name="category" id="category">
                                ...
                                <option @if ($category == 1) selected @endif value="1">คอร์สวิปัสสนา
                                </option>
                                <option @if ($category == 2) selected @endif value="2">คอร์สอานาปานสติ
                                </option>
                        ...
                        <div class="col-12 col-md-2">
                            ...
                            <select class="form-select" name="status" id="status">
                                ...
                                <option @if ($status == 'ยกเลิกคอร์ส') selected @endif value="ยกเลิกคอร์ส">ยกเลิกคอร์ส
                                </option>
                        ...
                        <div class="d-flex col-12 col-md-auto align-items-end gap-2">
                            <div>
                                ...
                                <select class="form-select" name="year" id="year">
                                    ...
                                    @for ($y = \Carbon\Carbon::now()->year + 1; $y >= 2011; $y--)
                                        <option @if ($year_s == $y) selected @endif
                            ...
                            <div>
                                ...
                                <select class="form-select" name="month" id="month">
                                    ...
                                    <option @if ($month_s == 0) selected @endif value="0">ทั้งหมด
                                    </option>
                                    @for ($m = 1; $m <= 12; $m++)
                                        <option @if ($month_s == $m) selected @endif
                                            value="{{ $m }}">{{ $m }}</option>
                                    @endfor
                                </select>
                            </div>
                        ...
                        <tr>
                            <td class="text-center">
                                ...
                                <a class="btn btn-info"
                                    href="{{ route('admin.courses.edit', ['course_id' => $course->id]) }}">
                                    {{ $course->id }}
                                </a>
                            </td>
                            <td class="text-center">{{ $course->state }}</td>
                            <td class="text-left " data-order="{{ $course->date_start }}">{{ $course->date_range }}</td>
                            ...
                            <td><a target="_blank" href="{{ url('admin/courses/applylist') . "/$course->id" }}"
                                    class="btn btn-sm btn-active">เปิดดู</a></td>
                            <td><a href="{{ route('admin.applylist.download', $course->id) }}"
                                    class="btn btn-sm btn-active">Download</a></td>

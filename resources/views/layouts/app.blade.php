                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item ms-2">
                            <a class="btn btn-danger text-white fw-bold px-3 shadow"
                                href="{{ route('showCourseForStudent') }}">
                        ...
                        @if (Auth::check() && Auth::user()->admin == 1)
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-primary fw-bold" href="#" id="adminMenu"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="adminMenu">
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('admin.members.senior') }}">จัดการสมาชิก senior</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('calendar.index') }}">จัดการปฏิทิน</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        ...
                                        <img src="{{ asset('images/eng.svg') }}" alt="English" width="24"
                                            class="me-2"> English
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        ...
                                        <img src="{{ asset('images/th.svg') }}" alt="Thai" width="24"
                                            class="me-2"> ไทย
                                    </a>
                                </li>
                            </ul>
